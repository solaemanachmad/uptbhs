          ...
          <div className="bg-white rounded-2xl p-6 shadow">
            <div className="mb-6">
              <div className="w-36 h-36 rounded-full  mb-5 mx-auto overflow-hidden">
                <Image
                  src={courseDetailsByInstructor?.profileImageInstructor}
                  alt={courseDetailsByInstructor?.fullNameInstructor}
                  width={300}
                  height={300}
              ...
              <div>
                <h4 className="text-xl lg:text-2xl text-center">
                  {courseDetailsByInstructor?.fullNameInstructor}
                </h4>
                <div className="text-gray-600 font-medium mb-6 text-sm text-center">
                  {courseDetailsByInstructor?.designationInstructor}
                </div>
            ...
            <p className="text-gray-600 text-xs leading-[1.8] text-justify">
              {courseDetailsByInstructor?.bioInstructor}
